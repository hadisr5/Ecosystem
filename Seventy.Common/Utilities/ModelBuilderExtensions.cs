...
namespace Seventy.Common.Utilities
{
    public static class ModelBuilderExtensions
    {
        ...
        {
            modelBuilder.Entity<IdentityUserLogin<Guid>>().ToTable("UserLogin", "Security");
            modelBuilder.Entity<IdentityUserClaim<Guid>>().ToTable("UserClaim", "Security");
            modelBuilder.Entity<IdentityUserRole<Guid>>().ToTable("UserRole", "Security");
            modelBuilder.Entity<IdentityUserToken<Guid>>().ToTable("UserToken", "Security");
            modelBuilder.Entity<IdentityRoleClaim<Guid>>().ToTable("RoleClaim", "Security");
        }
